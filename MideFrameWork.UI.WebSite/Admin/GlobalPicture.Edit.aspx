<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GlobalPictureEdit.aspx.cs" Inherits="MideFrameWork.UI.WebSite.Admin.GlobalPictureEdit" %>
...
<body>
    ...
    <div style="padding-bottom:200px;">
        <table>
                ...
                <td>                    
                                                                       <asp:TextBox id="TextBox_ShowTextCN" runat="server" Width="200px"></asp:TextBox>
                               </td>
            </tr>
                      		            <tr>
                <td>
                ...
                <td>                    
                                                                       <asp:TextBox id="TextBox_ShowTextEN" runat="server" Width="200px"></asp:TextBox>
                               </td>
            </tr>
                      		            <tr>
                <td>
