...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Groups.aspx.cs" Inherits="MideFrameWork.UI.WebSite.Admin.GroupsList" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function box_create_item() {
            manage.messagebox({ title: 'Groups管理', width: '600px', height: '350px', boxID: 'dialog-addConntact', showborder: true, showbg: true, fixed: true, content: 'iframe:/Admin/Groups.Edit.aspx' });
            return false;
        }
    </script>
    <script type="text/javascript">
...
<body>
    ...
    <table  class="table table-hover table-condensed bordered">
        <asp:Repeater ID="GroupsRepeat" runat="server">
            <HeaderTemplate>
                <tr>
                    <th>
            ...
            <ItemTemplate>
                <tr>
                    ...
                    <td>
                        <a href="javascript:void(0);" id="test" onclick="aa({ title: 'Groups管理', width: '600px', height: '350px', boxID: 'dialog-addConntact', showborder: true, showbg: true, fixed: true, content: 'iframe:/Admin/Groups.Edit.aspx?ctrID=<%#Eval("ID") %>' })">
                            编辑</a>
                    </td>
                </tr>
            </ItemTemplate>
