...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WG_OnGoingGifts.aspx.cs" Inherits="MideFrameWork.UI.WebSite.Admin.WG_OnGoingGiftsList" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function box_create_item() {
            manage.messagebox({ title: '礼物领取列表管理', width: '600px', height: '350px', boxID: 'dialog-addConntact', showborder: true, showbg: true, fixed: true, content: 'iframe:/Admin/WG_OnGoingGifts.Edit.aspx' });
            return false;
        }
    </script>
    <script type="text/javascript">
...
<body>
    ...
    <table  class="table table-hover table-condensed bordered">
        <asp:Repeater ID="WG_OnGoingGiftsRepeat" runat="server">
            <HeaderTemplate>
                <tr>
                    <th>
            ...
            <ItemTemplate>
                <tr>
                    ...
                    <td>
                        <a href="javascript:void(0);" id="test" onclick="aa({ title: '礼物领取列表管理', width: '600px', height: '350px', boxID: 'dialog-addConntact', showborder: true, showbg: true, fixed: true, content: 'iframe:/Admin/WG_OnGoingGifts.Edit.aspx?ctrID=<%#Eval("ID") %>' })">
                            编辑</a>
                    </td>
                </tr>
            </ItemTemplate>
