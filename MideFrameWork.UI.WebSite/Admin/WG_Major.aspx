...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WG_Major.aspx.cs" Inherits="MideFrameWork.UI.WebSite.Admin.WG_MajorList" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function box_create_item() {
            manage.messagebox({ title: '专业表管理', width: '600px', height: '350px', boxID: 'dialog-addConntact', showborder: true, showbg: true, fixed: true, content: 'iframe:/Admin/_CommonSelectBox.aspx?keywords=&tableName=WG_Education&displaycolumns=*&callbackcolumns=id,name' });
            return false;
        }
    </script>
    <script type="text/javascript">
...
<body>
    ...
    <table  class="table table-hover table-condensed bordered">
        <asp:Repeater ID="WG_MajorRepeat" runat="server">
            <HeaderTemplate>
                <tr>
                    <th>
            ...
            <ItemTemplate>
                <tr>
                    ...
                    <td>
                        <a href="javascript:void(0);" id="test" onclick="aa({ title: '专业表管理', width: '600px', height: '350px', boxID: 'dialog-addConntact', showborder: true, showbg: true, fixed: true, content: 'iframe:/Admin/WG_Major.Edit.aspx?ctrID=<%#Eval("ID") %>' })">
                            编辑</a>
                    </td>
                </tr>
            </ItemTemplate>
