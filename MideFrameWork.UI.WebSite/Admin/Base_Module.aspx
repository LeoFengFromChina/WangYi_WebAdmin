<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Base_Module.aspx.cs" Inherits="MideFrameWork.UI.WebSite.Admin.Base_ModuleList" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function box_create_item() {
            manage.messagebox({ title: 'Base_Module管理', width: '600px', height: '350px', boxID: 'dialog-addConntact', showborder: true, showbg: true, fixed: true, content: 'iframe:/Admin/Base_Module.Edit.aspx' });
            return false;
        }
    </script>
    <script type="text/javascript">
...
<body>
    <form id="form1" runat="server">
        ...
        <table class="table table-hover table-condensed bordered">
            <asp:Repeater ID="Base_ModuleRepeat" runat="server">
                <HeaderTemplate>
                    <tr>
                        <th>
                ...
                <ItemTemplate>
                    <tr>
                        ...
                        <td>
                            <a href="javascript:void(0);" id="test" onclick="aa({ title: 'Base_Module管理', width: '600px', height: '350px', boxID: 'dialog-addConntact', showborder: true, showbg: true, fixed: true, content: 'iframe:/Admin/Base_Module.Edit.aspx?ctrID=<%#Eval("ID") %>' })">编辑</a>
                        </td>
                    </tr>
                </ItemTemplate>
            </asp:Repeater>
