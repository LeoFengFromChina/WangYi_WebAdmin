        ...
        <asp:Repeater ID="Base_ModuleRepeat" runat="server">
            ...
            <ItemTemplate>
                <tr>
                    ...
                    <td>
                        <a href="javascript:void(0);" id="test" onclick="aa({ title: 'Base_Module管理', width: '600px', height: '350px', boxID: 'dialog-addConntact', showborder: true, showbg: true, fixed: true, content: 'iframe:/Admin/Base_Module.Edit.aspx?ctrID=<%#Eval("ID") %>' })">
                            编辑</a>
                    </td>
                </tr>
            </ItemTemplate>
