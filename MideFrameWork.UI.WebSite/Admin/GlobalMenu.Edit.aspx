<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GlobalMenuEdit.aspx.cs" Inherits="MideFrameWork.UI.WebSite.Admin.GlobalMenuEdit" %>
...
<body>
    ...
    <div style="padding-bottom:200px;">
        <table>
                ...
                <td>                    
                                                                       <asp:TextBox id="TextBox_MenuTextCN" runat="server" Width="200px"></asp:TextBox>
                               </td>
            </tr>
                      		            <tr>
                <td>
                ...
                <td>                    
                                                                       <asp:TextBox id="TextBox_MenuTextEN" runat="server" Width="200px"></asp:TextBox>
                               </td>
            </tr>
                      		            <tr>
                <td>
