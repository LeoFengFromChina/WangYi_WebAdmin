<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WG_TeamEdit.aspx.cs" Inherits="MideFrameWork.UI.WebSite.Admin.WG_TeamEdit" %>
...
<body>
    ...
    <div style="padding-bottom:200px;">
        <table>
                ...
                <td>                    
                                                                       <asp:TextBox id="TextBox_CaptainID" runat="server" Width="200px"></asp:TextBox>
                               </td>
            </tr>
                      		            <tr>
                <td>
                ...
                <td>                    
                                                                       <asp:TextBox id="TextBox_TeamAim" runat="server" Width="200px"></asp:TextBox>
                               </td>
            </tr>
                      		            <tr>
                <td>
