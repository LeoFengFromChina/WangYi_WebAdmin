<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FriendLinksEdit.aspx.cs" Inherits="MideFrameWork.UI.WebSite.Admin.FriendLinksEdit" %>
...
<body>
    ...
    <div style="padding-bottom:200px;">
        <table>
                ...
                <td>                    
                                                                       <asp:TextBox id="TextBox_LinkTextCN" runat="server" Width="200px"></asp:TextBox>
                               </td>
            </tr>
                      		            <tr>
                <td>
                ...
                <td>                    
                                                                       <asp:TextBox id="TextBox_LinkTextEN" runat="server" Width="200px"></asp:TextBox>
                               </td>
            </tr>
                      		            <tr>
                <td>
