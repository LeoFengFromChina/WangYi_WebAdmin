...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FriendLinks.aspx.cs" Inherits="MideFrameWork.UI.WebSite.Admin.FriendLinksList" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function box_create_item() {
            manage.messagebox({ title: 'FriendLinks管理', width: '600px', height: '350px', boxID: 'dialog-addConntact', showborder: true, showbg: true, fixed: true, content: 'iframe:/Admin/FriendLinks.Edit.aspx' });
            return false;
        }
    </script>
    <script type="text/javascript">
...
<body>
    ...
    <table  class="table table-hover table-condensed bordered">
        <asp:Repeater ID="FriendLinksRepeat" runat="server">
            <HeaderTemplate>
                <tr>
                    <th>
            ...
            <ItemTemplate>
                <tr>
                    ...
                    <td>
                        <a href="javascript:void(0);" id="test" onclick="aa({ title: 'FriendLinks管理', width: '600px', height: '350px', boxID: 'dialog-addConntact', showborder: true, showbg: true, fixed: true, content: 'iframe:/Admin/FriendLinks.Edit.aspx?ctrID=<%#Eval("ID") %>' })">
                            编辑</a>
                    </td>
                </tr>
            </ItemTemplate>
