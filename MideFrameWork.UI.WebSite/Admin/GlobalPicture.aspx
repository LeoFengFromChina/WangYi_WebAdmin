            ...
            <asp:Repeater ID="GlobalPictureRepeat" runat="server">
                ...
                <ItemTemplate>
                    <tr>
                        ...
                        <td>
                            <a href="<%#Eval("IconUrl")%>" target="_blank">预览</a>
                        </td>
                        <td>
                            <%#Eval("LinkUrl")%>
                        </td>
                        ...
                        <td>
                            <%#Eval("GroupID").ToString()=="1"?"首页Banner":Eval("GroupID").ToString()=="2"?"礼物版块Banner":"其他"%>
                        </td>
                        <td>
                            <%#Eval("UpdateDate")%>
                        </td>
                        ...
                        <td>
                            <a href="javascript:void(0);" id="test" onclick="aa({ title: '图片轮播管理', width: '600px', height: '350px', boxID: 'dialog-addConntact', showborder: true, showbg: true, fixed: true, content: 'iframe:/Admin/GlobalPicture.Edit.aspx?ctrID=<%#Eval("ID") %>' })">编辑</a>
                        </td>
                    </tr>
                </ItemTemplate>
            </asp:Repeater>
